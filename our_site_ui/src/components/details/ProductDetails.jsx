...
const ProductDetail = ({ product }) => {
    ...
    return (
        ...
        <>
            ...
            <Typography style={{ display: "flex", marginTop: 5, color: '#878787', fontSize: 14 }}>
                8 Ratings & 1 Reviews
                <Box componet="span" > <img src={fassured} style={{ width: 77, marginLeft: 20 }} alt='FassrdPic' /></Box>
            </Typography>
            <Typography>
            ...
            <Table>
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell colSpan={2}>
                            <img src={adURL} style={{ width: 390 }} alt='FassrdPic' />
                        </TableCell>
                    </TableRow>
                    <ColumnText>
